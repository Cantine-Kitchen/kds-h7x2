          ...
          <div style="margin-top:auto; padding-top:4px; border-top:1px solid #eee;">
            <div style="display:flex; align-items:center; justify-content:space-between; gap:10px;">
              ...
              <div style="text-align:right;">
                <div style="font-size:9px; font-weight:bold; display:flex; gap:6px; justify-content:flex-end; align-items:center; font-family:'Jadeite', sans-serif;">
                  ${fbIcon} cantinebar &nbsp; ${igIcon} cantine_bar
                </div>
                <div style="font-size:9px; font-weight:bold; color:#c85c33; margin-top:1px; font-family:'Jadeite', sans-serif;">
                  Summer 2026 &nbsp;|&nbsp; Executive Chef - Michael Booth &nbsp;|&nbsp; General Manager - Jessica Kerlin
                </div>
              </div>
            </div>
            <div style="font-size:7.5px; color:#444; line-height:1.15; text-align:center; margin-top:3px; font-family:'MixSerif', Georgia, serif;">
      ...
      <div class="legal-grid-2col">
        ...
        <div class="legal-col">
          ...
          <div style="margin-top:auto; border:2px solid #000; padding:6px; text-align:center; background:#fafafa;">
            <h4 style="margin:0 0 3px 0; color:#c85c33; font-family:'Jadeite', sans-serif; font-size:12px; letter-spacing:2px;">CANTINE DAILY</h4>
            <div style="font-family:'MixSerif', Georgia, serif; font-size:9px; line-height:1.3; color:#111; font-weight:bold;">
    ...
    const promoBoxHtml = isPage1
      ? `
        <div class="cutout-promo-box">
          <div style="font-family:'Jadeite', sans-serif; font-size:10.5px; font-weight:900; color:#c85a32; letter-spacing:1px; margin-bottom:4px; text-transform:uppercase; text-align:center;">CANTINE DAILY</div>
          ${promosHtml}
        </div>
      `
      : '';
